  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="flex flex-wrap justify-between items-center bg-gray-800 text-white p-1 py-4 px-10 ">
          <div>
            <Image className="absolute top-5" width={60} height={60} src={"/logo.png"} alt="logo">
            </Image>
          </div>
          <div className="text-xl font-sans font-bold">Tuition Free Education Program on Latest Technologies</div>
          <div className="flex items-center gap-5 font-sans font-">
            <Link href="/">
              Home
            </Link>
            <Link href="#">
            ...
            {/* Courses Dropdown ---- this component created src / components folder */}
            <CoursesDropdown />
          </div>
        </div>
        ...
        {/*
          ...
          <div className="flex flex-wrap justify-between items-center bg-black text-white p-1">
          <div className="my-1"><svg
          ...
          <div className="text-3xl font-mono">Flexbox Application</div>
